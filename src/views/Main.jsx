        ...
        <div className="container">
          ...
          <div className="nav-scroller py-1 mb-3 border-bottom">
            <nav className="nav nav-underline justify-content-between">
              <a className="nav-item nav-link link-body-emphasis active" href="#">Декоративная косметика</a>
              <a className="nav-item nav-link link-body-emphasis" href="#">Уходовая косметика</a>
              <a className="nav-item nav-link link-body-emphasis" href="#">Книги</a>
              <a className="nav-item nav-link link-body-emphasis" href="#">Кинематограф</a>
            </nav>
          </div>
        </div>
        ...
        <main className="container">
          <div className="p-4 p-md-5 mb-4 rounded text-body-emphasis bg-body-secondary">
            <div className="col-lg-6 px-0">
              <h1 className="display-4 fst-italic">Жаркое и долгожданное</h1>
              <p className="lead my-3">Важно беречь свою кожу от ультрафиолетовых лучей, чтобы сохранить ее молодость и здоровье. Ознакомьтесь с рекомендациями SPF-средств. </p>
              <p className="lead mb-0"><a href="#" className="text-body-emphasis fw-bold">Продолжить...</a></p>
            </div>
          </div>
            ...
            <div className="col-md-6">
              <div className="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                <div className="col p-4 d-flex flex-column position-static">
                  <strong className="d-inline-block mb-2 text-primary-emphasis">Книги</strong>
                  <h3 className="mb-0">Виктор Гюго "Отверженные"</h3>
                  <div className="mb-1 text-body-secondary"> 12.07 </div>
                  <p className="card-text mb-auto">Погружение в атмосферу или много воды? Стоит ли читать роман, если половина книги это просто описание</p>
